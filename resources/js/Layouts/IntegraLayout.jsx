...
export default function IntegraLayout({ header, children }) {
                    ...
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            <div className="shrink-0 flex items-center">
                                <Link href="/payables">
                                    <ApplicationLogo className="block h-[78px] w-auto fill-current text-gray-800 dark:text-gray-200" />
                                </Link>
                            </div>

                            <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink href={route('payables.index')} active={route().current('payables.index')}>
                                    Conta a Pagar
                                </NavLink>
